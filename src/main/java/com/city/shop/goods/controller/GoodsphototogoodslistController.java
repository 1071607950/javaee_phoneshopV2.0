 ...
 * 
 * @author
 * @category 买家查看商品图片前分发
 */
@WebServlet("/pages/buyer/goodslistphoto.do")
public class GoodsphototogoodslistController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GoodsphototogoodslistController() {
		super();
