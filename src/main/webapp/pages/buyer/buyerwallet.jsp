			...
			<div class="row">
				<div class="col-xs-12">
					<div class="box">
		            	...
		            	<label for="inputEmail3" class="col-sm-12 ">余额:${buyer.wallet}</label>
			            <!-- /.box-header -->
			            <div class="box-body">
					        <form class="form-horizontal" action="buyerwallet.do?type=1" method="post">
					    	...
					    	<form class="form-horizontal" action="buyerwallet.do?type=2" method="post">
								<div class="form-group">
